...
class ConversationTitleGenerationService:
    ...
    def generate_conversation_title(self, user_message: str) -> Dict[str, Any]:
        """
        为用户第一条消息生成30字以内的对话标题
        
        Args:
            user_message: 用户输入的第一条消息
        ...
        try:
            ...
            # 生成标题
            raw_title = self.conversation_title_chain.invoke({"conversation_content": user_message})
