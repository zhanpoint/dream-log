...
新增 `backend-v2/app/models/notification.py`：
...
新增 `backend-v2/app/services/notification_service.py`：
...
新增 `backend-v2/app/api/notifications.py`：
...
新增 `backend-v2/app/services/insight_service.py`：
...
新增 `backend-v2/app/prompts/insight_generation.py`：
...
新增 `backend-v2/app/services/pattern_service.py`：
...
新增 `backend-v2/app/config/insight_config.py`：
...
修改 `backend-v2/app/core/arq_app.py`，添加 cron 任务支持：
...
新增 `backend-v2/app/tasks/insight_tasks.py`：
...
新增 `backend-v2/app/api/insights.py`：
...
修改 `backend-v2/app/api/user.py`，添加：
...
新增 `frontend-v2/lib/stores/notification-store.ts`（使用 Zustand）：
...
新增 `frontend-v2/components/notifications/notification-bell.tsx`：
...
新增 `frontend-v2/app/(app)/notifications/page.tsx`：
...
新增 `frontend-v2/app/(app)/insights/page.tsx`：
...
新增 `frontend-v2/app/(app)/insights/monthly/[id]/page.tsx`：
...
新增 `frontend-v2/app/(app)/insights/pattern/[id]/page.tsx`：
...
修改 `frontend-v2/components/settings/settings-sidebar.tsx`：
...
新增 `frontend-v2/app/settings/insights/page.tsx`：
...
新增 `frontend-v2/components/charts/`：
