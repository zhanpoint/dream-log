...
脚本位置：`backend/scripts/symbols/`（梦境象征符号相关脚本统一放此目录）
...
- `[backend/app/models/exploration.py](backend/app/models/exploration.py)` — SQLAlchemy 模型
- `[backend/app/schemas/exploration.py](backend/app/schemas/exploration.py)` — Pydantic 响应模型
- `[backend/app/api/exploration.py](backend/app/api/exploration.py)` — API 路由
- `[backend/scripts/symbols/](backend/scripts/symbols/)` — 梦境象征符号脚本目录
...
- `[frontend/app/(app)/exploration/page.tsx](frontend/app/(app)`/exploration/page.tsx) — 模块主页（4个子模块入口卡片）
- `[frontend/app/(app)/exploration/symbols/page.tsx](frontend/app/(app)`/exploration/symbols/page.tsx) — 符号词典（搜索+分类）
- `[frontend/app/(app)/exploration/symbols/[slug]/page.tsx](frontend/app/(app)`/exploration/symbols/[slug]/page.tsx) — 符号详情（7层结构展示）
- `[frontend/app/(app)/exploration/science/page.tsx](frontend/app/(app)`/exploration/science/page.tsx) — 梦境科学基础
- `[frontend/app/(app)/exploration/nightmare/page.tsx](frontend/app/(app)`/exploration/nightmare/page.tsx) — 噩梦应对指南
- `[frontend/app/(app)/exploration/improvement/page.tsx](frontend/app/(app)`/exploration/improvement/page.tsx) — 梦境改善指南

### 导航栏修改

在 `[frontend/components/site-header.tsx](frontend/components/site-header.tsx)` 第 74 行「洞察报告」链接后添加「梦境探索」导航项，使用 `Compass` 图标（lucide-react 已有）。
