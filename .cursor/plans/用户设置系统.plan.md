...
**文件**: `[backend-v2/app/models/user.py](backend-v2/app/models/user.py)`
...
**文件**: `[backend-v2/app/services/oss_service.py](backend-v2/app/services/oss_service.py)`（新建）
...
**环境变量**（`[backend-v2/app/core/config.py](backend-v2/app/core/config.py)`）：
...
**文件**: `[backend-v2/app/services/username_service.py](backend-v2/app/services/username_service.py)`（新建）
...
**文件**: `[backend-v2/app/api/user.py](backend-v2/app/api/user.py)`（新建）
...
**文件**: `[backend-v2/app/services/user_service.py](backend-v2/app/services/user_service.py)`（新建）
...
**文件**: `[frontend-v2/components/site-header.tsx](frontend-v2/components/site-header.tsx)`
...
**文件**: `[frontend-v2/components/user-avatar.tsx](frontend-v2/components/user-avatar.tsx)`（新建）
...
**文件**: `[frontend-v2/app/settings/layout.tsx](frontend-v2/app/settings/layout.tsx)`（新建）
...
**文件**: `[frontend-v2/components/settings/settings-sidebar.tsx](frontend-v2/components/settings/settings-sidebar.tsx)`（新建）
...
**文件**: `[frontend-v2/app/settings/profile/page.tsx](frontend-v2/app/settings/profile/page.tsx)`（新建）
...
**文件**: `[frontend-v2/components/settings/avatar-upload-modal.tsx](frontend-v2/components/settings/avatar-upload-modal.tsx)`（新建）
...
**文件**: `[frontend-v2/lib/user-api.ts](frontend-v2/lib/user-api.ts)`（新建）
...
**文件**: `[frontend-v2/i18n/index.ts](frontend-v2/i18n/index.ts)`
...
**前端逻辑**（`[frontend-v2/lib/utils.ts](frontend-v2/lib/utils.ts)`）：
...
**后端逻辑**（`backend-v2/app/services/username_service.py`）：
