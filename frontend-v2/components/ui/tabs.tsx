...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center bg-background p-0 shadow-sm shadow-black/5 rounded-lg",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "relative overflow-hidden border-b-2 border-border/30",
      "data-[state=active]:border-primary data-[state=active]:text-foreground",
      "hover:text-foreground hover:border-border/60 hover:-translate-y-0.5",
